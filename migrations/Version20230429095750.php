 ...
 */
final class Version20230429095750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE applications (id INT AUTO_INCREMENT NOT NULL, user INT NOT NULL, offer INT NOT NULL, is_validated TINYINT(1) DEFAULT NULL, workplace VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, username VARCHAR(50) NOT NULL, userfirstname VARCHAR(60) NOT NULL, email VARCHAR(255) NOT NULL, recruteur VARCHAR(255) NOT NULL, cv VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
